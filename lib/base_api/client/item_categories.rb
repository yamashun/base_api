  ...
  class Client
    module ItemCategories
      ...
      def item_categories_detail(item_id)
        call_get_api("/1/item_categories/detail/#{item_id}")
      end
      ...
      def item_categories_add(item_id, category_id)
        call_post_api('/1/item_categories/add', { item_id: item_id, category_id: category_id })
      end
      ...
      def item_categories_delete(item_category_id)
        call_post_api('/1/item_categories/delete', { item_category_id: item_category_id })
      end
    end
  end
end
